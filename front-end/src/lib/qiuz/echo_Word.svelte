...
//   status_send = false
  ...
  <div class="w-full h-full flex flex-col md:flex-row items-center justify-center gap-8">
    ...
    <div class="w-full md:w-auto flex flex-col justify-start items-center">
        ...
        <div class="w-full md:w-[30rem] rounded-xl text-5xl py-[30px] px-2 flex justify-center items-center text-center bg-white shadow-[10px_10px_0px_0px_#373C4A] border-2 border-ec-dark-blue-1">
            {word.word_en}
        </div>
        </div>
        {#if msg !== ''}
