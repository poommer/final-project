...
<div class=" flex flex-col gap-5 justify-center items-center ">
    ...
    <div class="Q w-[25rem]">
        ...
        <div class="w-full flex mt-4">
            <div class="w-10/12 rounded-md bg-ec-dark-blue-3 text-ec-yellow flex justify-between items-center">
                <p class="w-10/12  p-4 text-center  text-5xl">
                    {#if show_word}
                    {word}
                    {/if}
                </p>
    ...
    <div class="a flex flex-col gap-5 justify-center items-center">
        <button class={`btn border-2  border-ec-dark-blue-1 bg-ec-dark-blue-5 w-[25rem] shadow-[5px_5px_0px_0px_#343946] hover:shadow-[5px_5px_0px_0px_#434d61]`}>
            <div class="w-full flex items-center justify-between">
                <div class="w-2/12 h-full flex items-center justify-center">
                    <p class="w-[2rem] h-[2rem] border-2 border-ec-dark-blue-2 rounded-md shadow-[0.5px_0.5px_0px_0px_#343946] text-2xl">
                        1
                    </p>
                </div>
...
<script>
    import { createEventDispatcher } from "svelte";
      ...
      const vocab = [
      {
          ...
          "status_image": 1,
          "wl_name": "greeting",
          "imageURL": "https://api-ecproject.poommer.in.th/media/image/vocab/wl004/Hello.webp",
          "soundURL": "https://api-ecproject.poommer.in.th/media/sound/vocab/wl004/Hello.wav"
      },
      {
          "lesCon_id": 9,
          "vocab_ID": "wl001-0003",
          ...
          "wl_name": "other",
          "imageURL": "none",
          "soundURL": "https://api-ecproject.poommer.in.th/media/sound/vocab/wl001/good.wav"
      },
      {
          "lesCon_id": 2,
          "vocab_ID": "wl002-0002",
          ...
          "status_image": 1,
          "wl_name": "animal",
          "imageURL": "https://api-ecproject.poommer.in.th/media/image/vocab/wl002/dog.webp",
          "soundURL": "https://api-ecproject.poommer.in.th/media/sound/vocab/wl002/dog.wav"
      },
      {
          "lesCon_id": 3,
          "vocab_ID": "wl003-0001",
          ...
          "status_image": 1,
          "wl_name": "food & drink",
          "imageURL": "https://api-ecproject.poommer.in.th/media/image/vocab/wl003/water.webp",
          "soundURL": "https://api-ecproject.poommer.in.th/media/sound/vocab/wl003/water.wav"
      }
  ];
  ...
  let checkAns = async () => {
      console.log({check:Ans == word, Ans, word});
        ...
        if(maxAns > 0){
            maxAns -= 1
            if(Ans !== word){
                if(maxAns === 1){msg = 'ไม่เป็นไร ให้ลองอีกครั้ง'}else {  msg = 'ไว้ฝึกมาใหม่นะ' ;  score = 1 ; status_send = true; console.log(score); }
            }else{ 
                score = maxAns === 1 ? 5 : 3
                status_send = true
                msg = 'good job!'; 
  ...
  $:({maxAns, msg, nextStatus} = config);
      ...
      let chioce = shuffleArray(getThreeItems(vocab, word))
      chioce = shuffleArray(chioce)
      chioce = shuffleArray(chioce)
      console.log(chioce);
  ...
  <div class=" flex flex-col gap-5 justify-center items-center ">
      ...
      <div class="Q w-[25rem]">
          <p class="text-2xl text-ec-yellow flex items-center gap-1">
              <svg xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="32px" fill="#EAC452"><path d="M240-80v-172q-57-52-88.5-121.5T120-520q0-150 105-255t255-105q125 0 221.5 73.5T827-615l52 205q5 19-7 34.5T840-360h-80v120q0 33-23.5 56.5T680-160h-80v80h-80v-160h160v-200h108l-38-155q-23-91-98-148t-172-57q-116 0-198 81t-82 197q0 60 24.5 114t69.5 96l26 24v208h-80Zm254-360Zm-14 120q17 0 28.5-11.5T520-360q0-17-11.5-28.5T480-400q-17 0-28.5 11.5T440-360q0 17 11.5 28.5T480-320Zm-30-128h61q0-25 6.5-40.5T544-526q18-20 35-40.5t17-53.5q0-42-32.5-71T483-720q-40 0-72.5 23T365-637l55 23q7-22 24.5-35.5T483-663q22 0 36.5 12t14.5 31q0 21-12.5 37.5T492-549q-20 21-31 42t-11 59Z"/></svg>
              เลือกคำศัพท์ให้ตรงกับเสียงที่ปรากฏ
          </p>
          <div class="w-full flex mt-4">
            <div class="w-10/12 rounded-md bg-ec-dark-blue-3 text-ec-yellow flex justify-between items-center">
                <p class="w-10/12  p-4 text-center  text-5xl">
            ...
            <button on:click={()=>{playSound(sound_Ans)}} class="w-2/12 flex justify-center items-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#FFFFFF"><path d="M560-131v-82q90-26 145-100t55-168q0-94-55-168T560-749v-82q124 28 202 125.5T840-481q0 127-78 224.5T560-131ZM120-360v-240h160l200-200v640L280-360H120Zm440 40v-322q47 22 73.5 66t26.5 96q0 51-26.5 94.5T560-320ZM400-606l-86 86H200v80h114l86 86v-252ZM300-480Z"/></svg>
            </button>
        </div>
      </div>
